...
function load_city_list() {
  ...
  switch (cityCurrentQuestion) {
    case "A2b":
      if (api.fn.answers().A2a ==9999999) {
        country = api.fn.answers().A1;
      } else {
        country = api.fn.answers().A2a;
      }
      break;
    case "B3":
      if (api.fn.answers().B2) {
        country = api.fn.answers().B2;
      } 
      break;     
    case "B7":
      country = "_all"; 
 ...
 console.log("cityCurrentQuestion:", cityCurrentQuestion );
  ...
  switch (cityCurrentQuestion) {
    ...
    case "E8":
      ...
      break;      
    case "G3_City_Original":
      api.fn.answers({G3_City_Original:  savedData});
      break;       
    case "G3_City_New":
      api.fn.answers({G3_City_New:  savedData});
      break;                
    default:
      break;         
  }
